...
class GitDiffTool(BaseTool):
    ...
    parameters = {
        "type": "object",
        "properties": {"staged": {"type": "boolean", "description": "Set true to inspect staged diffs."}},
        "required": [],
    }
...
class GitCommitTool(BaseTool):
    ...
    parameters = {
        "type": "object",
        "properties": {"message": {"type": "string", "description": "Commit message describing the changes."}},
        "required": ["message"],
    }
